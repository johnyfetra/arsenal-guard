...
- **`reveal-ready` class**: Added to `<html>` synchronously in HEAD inline script if `prefers-reduced-motion` is not set
...
- **No unnecessary dependencies** — keep bundle minimal
...
- `project-context.md` — project context (superseded by this file for Copilot sessions)
